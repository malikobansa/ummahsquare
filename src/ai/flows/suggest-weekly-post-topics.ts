...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a social media manager for UmmahSquare. Suggest 5 post topics based on the following weekly theme:\n\n{{weeklyTheme}}\n\nMake the topics engaging and relevant to the UmmahSquare community. Return the post topics as a JSON array of strings.`,
});
